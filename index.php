        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    <li class="nav-item">
                        <a class="nav-link active text-sm-start text-center" aria-current="page" href="profil.html">profile</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-5">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Selamat datang di situs web kami yang berfokus pada penyajian dan manajemen data mahasiswa. Situs ini dirancang untuk memberikan informasi yang mudah diakses tentang mahasiswa yang terdaftar di institusi pendidikan kami. Dengan antarmuka yang ramah pengguna, Anda dapat menjelajahi dan mencari informasi tentang berbagai mahasiswa di berbagai program studi.</p>
